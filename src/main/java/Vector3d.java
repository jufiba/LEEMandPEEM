 ...
 * 
 * It has been modified in by Juan de la Figuera 1/12/2016 to add spherical coordinates funcionality.
 */
...
public class Vector3d {
    ...
    public double times(Vector3d a,Vector3d b) {
    ...
    /**
     * Return vector perpendicular to b and c, used for reciprocal space directions
     * @param a
     * @param b
     * @param c
     * @return a new vector
     */
    public static Vector3d perp(Vector3d a, Vector3d b, Vector3d c) {
    	Vector3d v;
    	v=cross(b,c);
    	v.times(1.0/v.scalar(a));
    	return(v);
    }
